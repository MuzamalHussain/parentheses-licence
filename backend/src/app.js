...
app.use("/api/v1/identity",            require("./routes/identity"));
...
app.use("/api/v1/admin/rbac",            require("./routes/adminRbac"));
app.use("/api/v1/admin/identity",        require("./routes/adminIdentity"));
app.use("/api/v1/admin/compliance",      require("./routes/adminCompliance"));
app.use("/api/v1/admin/ai",              require("./routes/adminAI"));
app.use("/api/v1/admin/ai-assistant",    require("./routes/adminAIAssistant"));
app.use("/api/v1/admin/ai-business",     require("./routes/adminAIBusiness"));
app.use("/api/v1/admin/ai-fraud",        require("./routes/adminAIFraud"));
app.use("/api/v1/admin/ai-workflows",    require("./routes/adminAIWorkflow"));
app.use("/api/v1/admin/ai-command",      require("./routes/adminAICommand"));
app.use("/api/v1/admin/ai-release",      require("./routes/adminAIRelease"));
app.use("/api/v1/admin/ai-developer",    require("./routes/adminAIDeveloper"));
app.use("/api/v1/admin/ai-forecast",     require("./routes/adminAIForecast"));
app.use("/api/v1/admin/ai-governance",   require("./routes/adminAIGovernance"));
